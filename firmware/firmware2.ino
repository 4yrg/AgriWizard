...
const char* SENSOR_ID = "e3919d0b-aae0-4d33-ae2f-88aa1d147227";
const char* SOIL_SENSOR_ID = "e3919d0b-aae0-4d33-ae2f-88aa1d147227";
...
void publishTelemetry() {
  ...
  if (ok) {
    logLine("telemetry publish OK topic=" + sensorTelemetryTopic + " bytes=" + String(n) + " payload=" + String(payload));
  } else {
    logLine(
      "telemetry publish FAIL topic=" + sensorTelemetryTopic +
      " bytes=" + String(n) +
      " topic_len=" + String(sensorTelemetryTopic.length()) +
      " mqtt_connected=" + String(mqttClient.connected() ? "true" : "false") +
      " mqtt_state=" + String(mqttClient.state()) +
