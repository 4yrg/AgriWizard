...
export IAM_UPSTREAM_HOST="${IAM_UPSTREAM_HOST:-https://iam-service.${ACA_FQDN_SUFFIX}}"
export IAM_UPSTREAM_PORT="${IAM_UPSTREAM_PORT:-443}"
export HARDWARE_UPSTREAM_HOST="${HARDWARE_UPSTREAM_HOST:-https://hardware-service.${ACA_FQDN_SUFFIX}}"
export HARDWARE_UPSTREAM_PORT="${HARDWARE_UPSTREAM_PORT:-443}"
export ANALYTICS_UPSTREAM_HOST="${ANALYTICS_UPSTREAM_HOST:-https://analytics-service.${ACA_FQDN_SUFFIX}}"
export ANALYTICS_UPSTREAM_PORT="${ANALYTICS_UPSTREAM_PORT:-443}"
export WEATHER_UPSTREAM_HOST="${WEATHER_UPSTREAM_HOST:-https://weather-service.${ACA_FQDN_SUFFIX}}"
export WEATHER_UPSTREAM_PORT="${WEATHER_UPSTREAM_PORT:-443}"
export NOTIFICATION_UPSTREAM_HOST="${NOTIFICATION_UPSTREAM_HOST:-https://notification-service.${ACA_FQDN_SUFFIX}}"
