...
SERVICE_BUS_TELEMETRY_TOPIC="${SERVICE_BUS_TELEMETRY_TOPIC:-telemetry-events}"
SERVICE_BUS_NOTIFICATIONS_TOPIC="${SERVICE_BUS_NOTIFICATIONS_TOPIC:-notifications}"
...
deploy_internal_app "hardware-service" "agriwizard-hardware-service" "8082" "1" "3" "${INGEST_CPU}" "${INGEST_MEMORY}" \
  ...
  "MQTT_PASSWORD=${MQTT_PASSWORD}" \
  "SERVICE_BUS_CONNECTION=${SERVICE_BUS_CONNECTION}" \
  "SERVICE_BUS_TOPIC=${SERVICE_BUS_TELEMETRY_TOPIC}" \
  "GIN_MODE=release" \
  "APPLICATIONINSIGHTS_CONNECTION_STRING=${APP_INSIGHTS_CONNECTION_STRING}"
...
deploy_internal_app "notification-service" "agriwizard-notification-service" "8085" "1" "3" "${LIGHT_CPU}" "${LIGHT_MEMORY}" \
  ...
  "SERVICE_BUS_CONNECTION=${SERVICE_BUS_CONNECTION}" \
  "SERVICE_BUS_NAMESPACE=${SERVICE_BUS_NAMESPACE}" \
  "SERVICE_BUS_TOPIC=${SERVICE_BUS_NOTIFICATIONS_TOPIC}" \
